...
if __name__ == "__main__":
    ...
    corpus_handler.dump_to_arff('A2D12G_saimouli.arff', bigrams_frequency_distribution, 'Frequency Distribution', ['Bigram', 'Count'])
    corpus_handler.dump_to_arff('A2D13G_saimouli.arff', trigrams_frequency_distribution, 'Frequency Distribution', ['Trigram', 'Count'])
    corpus_handler.dump_to_arff('A2D14G_saimouli.arff', four_grams_frequency_distribution, 'Frequency Distribution',
                                ['Four_gram', 'Count'])

    # corpus_handler.dump_to_arff('A2D12G_yourLastName.arff', bigrams, 'Bigrams', ['Bigram_0', 'Bigram_1'])
    # corpus_handler.dump_to_arff('A2D13G_yourLastName.arff', trigrams, 'Trigrams', ['Trigram_0', 'Trigram_1', 'Trigram_2'])
    # corpus_handler.dump_to_arff('A2D14G_yourLastName.arff', four_grams, 'Four_grams',
