...
if __name__ == "__main__":
    ...
    corpus_handler.dump_to_arff('A1D2_saimouli.arff', frequency_distribution, 'Frequency Distribution', ['Token', 'Count'])
    ...
    print "Classes : Ham/Spam"
    print "Result : ",classifier.classify(corpus_handler.feature_extractor(word_tokenize("video shows offer")))
